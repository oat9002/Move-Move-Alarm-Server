...
public class SQLInquirer implements DatabaseInterface {
    ...
    public ArrayList<HashMap<String, Object>> query(String sqlCommand) throws SQLException {
        ...
        while(resultSet.next()) {
            HashMap<String, Object> temp = new HashMap<String, Object>(); //create new HashMap to keep each row of table
    ...
    public boolean startConnection()
    {
        try{
            ...
            connector =  DriverManager.getConnection("jdbc:mariadb://161.246.70.77/MoveAlarm" +
